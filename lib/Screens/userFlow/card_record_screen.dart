...
class _CardRecordScreenState extends State<CardRecordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(finalInt);
    return statusOfQr.value.isSuccess
        ? Scaffold(
            // floatingActionButton: Padding(
            //   padding: const EdgeInsets.only(bottom: 128.0, right: 10),
                        ...
                        child: Column(
                          ...
                          children: [
                            GridView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount:
                                    int.parse(stampsRemaining.toString()) +
                                        int.parse(stampsCollected.toString()),
                                itemBuilder: (c, i) {
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Row(
                            children: [
                              Image.network(
                                "https://pngimg.com/d/rubber_stamp_PNG27.png",
                                height: 20,
                                width: 20,
                                color: Colors.white,
                              ),
